...
insert into product(name, price, image, category_id, info) values ('Mikroaaltouuni', 99, 'placeholder.png', 3, Mikroaaltouunilla aterioiden valmistus on helppoa ja nopeaa. Siinä on suuri 17 litran tilavuus ja viisi tehoasetusta);
...
insert into product(name, price, image, category_id, info) values ('Pelikonsoli', 499, 'placeholder.png', 5, Nauti salamannopeasta latauksesta, erittäin nopeasta SSD-asemasta ja mukaansatempaavista toiminnoista, kuten kosketuspalautteesta, mukautuvista liipaisimista, 3D-äänestä ja upouudesta pelien sukupolvesta.);
